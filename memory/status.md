...
## Current status (2026-09-04, morning) — new blocker, one layer past the still-open FMUL/round3 investigation: `D3D8 private heap exhausted: alloc of 1048576 bytes... would push the heap cursor... past D3D8_HEAP_LIMIT (0x10000000)`. Not yet investigated.
...
Repro: `cd /data/Code/tew && TEW_MAX_STEPS=2000000000 LOG_CATEGORIES=-registry timeout 1200 .venv/bin/python run_exe.py` on branch `debug/mmx-usage-counter`.
